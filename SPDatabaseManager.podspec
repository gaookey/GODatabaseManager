#
#  Be sure to run `pod spec lint SPDatabaseManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "高文立"
  # spec.authors            = { "高文立" => "swiftprimer@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/高文立"
